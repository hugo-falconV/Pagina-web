...
var mf = {
    ...
    validarFormulario: function(){
        ...
        if(!pf.validarUsuario || !pf.validarPassword || !pf.validarEmail){
            ...
            document.querySelector("#labelEnviar").innerHTML = '<span style="color:red">*Tiene errores en los datos que ha ingresado, porfavor revisar de nuevo</span>'

            return false
        
        } else if (!pf.validarTerminos){

             document.querySelector("#labelEnviar").innerHTML = '<span style="color:red">*Porfavor acepte terminos y condiciones</span>'
